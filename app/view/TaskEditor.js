...
Ext.define('Gtd.view.TaskEditor', {
	...
	requires: ['Gtd.view.fields.ParentTask'],
  ...
  */
	initComponent: function () {
		this.items = [this.getTitleField(), this.getDescriptionField(), this.getParentTaskField(), this.getDueDateField()];
		this.buttons = [this.getCancelButton(), this.getOkButton()];
		this.callParent();
	},
